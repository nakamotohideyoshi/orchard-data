...
saveNewBatchFunction = function (sourceFile, artistBlacklist, keywordBlacklist, duplicatesThreshold, variousArtistsThreshold, lang, status, creationDate) {
  DB.serialize(
    function (source_file, artist_blacklist, keyword_blacklist, duplicates_threshold, various_artists_threshold, lang, status) {
...
module.exports = {
  ...
  saveNewBatch: saveNewBatchFunction
} // end module.exports
